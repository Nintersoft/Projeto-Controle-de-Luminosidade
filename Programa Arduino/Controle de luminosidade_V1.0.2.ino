  ...
  if (bluetooth.available()){                                       //--- Verifica se há algum comando recebido por bluetooth
    ...
    if (ativado == true){   
      ...
      if (manual == false){                                         //---------- Verifica se o controle manal está desativado
        if (letra == '8'){                                          //----- Verifica se há o comando é para o controle manual
        ...
        if (letra == '1'){                                          //-- Checa o caractere correscondente o nivel de corrente
        ...
        else if (letra == '2'){                                     //-- Checa o caractere correscondente o nivel de corrente
        ...
        else if (letra == '3'){                                     //-- Checa o caractere correscondente o nivel de corrente
        ...
        else if (letra == '4'){                                     //-- Checa o caractere correscondente o nivel de corrente
        ...
        else if (letra == '5'){                                     //-- Checa o caractere correscondente o nivel de corrente
        ...
        else if (letra == '9'){                                   //----- Verifica se há o comando é para o controle manual
            manual = false;                                         //---------------------- Identifica a variável como falsa
            digitalWrite(LED_ATIV , LOW);                           //------ LED mostra que o controle manual está desativado
            digitalWrite(NIVEL1, HIGH);                             //------------------ Desativa os níveis mais baixos (PNP)
            digitalWrite(NIVEL2, HIGH);                             //------------------ Desativa os níveis mais baixos (PNP)
            digitalWrite(NIVEL3, HIGH);                             //------------------ Desativa os níveis mais baixos (PNP)
            digitalWrite(NIVEL4, HIGH);                             //------------------ Desativa os níveis mais baixos (PNP)
